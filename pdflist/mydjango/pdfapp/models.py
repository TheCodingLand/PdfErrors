...
class PDF(models.Model):
    hashstr = models.CharField(max_length=200, unique=True)
    size = models.CharField(max_length=15, unique=False, blank=True, null=True)
...
class Error(models.Model):
    profil =models.CharField(max_length=200, null = True,unique=False) 
    text = models.CharField(max_length=600, unique=True, null = True)
    name = models.CharField(max_length=600, unique=False, null = True)
    page = models.CharField(max_length=600, unique=False, null=True, blank=True)
...
class Solution(models.Model):
    ...
    text = models.CharField(max_length=800, null = True)
